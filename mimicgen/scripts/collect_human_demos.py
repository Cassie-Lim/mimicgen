...
def gather_demonstrations_as_hdf5(directory, out_dir, env_info):
    ...
    for ep_directory in os.listdir(directory):
        ...
        if success:
            ...
            ep_data_grp.create_dataset("grasping_gripper_pose", data=np.array(grasping_gripper_pose))
            ep_data_grp.create_dataset("grasped", data=np.array(grasped))
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--environment", type=str, default="Lift_D0")
    ...
    parser.add_argument("--obj_xml_path", type=str, default=None)
    ...
    config = {
        ...
        "obj_xml_path": args.obj_xml_path,
    }
    ...
    obj_id = args.obj_xml_path.split('/')[-2]
    tmp_directory = f"tmp/obj_id_{obj_id}_{str(time.time()).replace('.', '_')}"
